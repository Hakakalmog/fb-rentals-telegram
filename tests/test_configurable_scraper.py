...
class FacebookTestScraper:
    ...
    def __init__(self):
        ...
        print(f"🧪 Facebook Test Scraper Initialized")
    ...
    def analyze_posts(self, posts):
        ...
        for i, post in enumerate(posts, 1):
            ...
            try:
                ...
                if result == "match":
                    match_count += 1
                    print(f"🎯 Result: ✅ MATCH - This apartment meets the criteria!")
                else:
                    no_match_count += 1
                    print(f"🎯 Result: ❌ NO MATCH - This post doesn't meet the criteria")
    ...
    def display_summary(self, analysis_summary):
        ...
        print(f"📁 Files saved in test_outputs/:")
        print(f"   📄 Scraped posts: scraped_posts/")
        print(f"   🤖 Analysis results: ollama_posts/")
...
async def main():
    ...
    print(f"🧪 Facebook Group Test Scraper")
    print(f"="*60)
    print(f"This test will:")
    print(f"• Scrape posts from TEST_FB_GROUP_URL")
    print(f"• Analyze up to TEST_MAX_POSTS posts")
    print(f"• Show which posts match apartment criteria")
    print(f"• Save results to test_outputs/ folders")
    print()
