...
חוקי בדיקה קפדניים - כל תנאי חייב להתקיים:

1. האם להשכרה? (כן אם כתוב "להשכרה", לא אם "למכירה")
2. האם 3 חדרים או יותר? 
   - חדר אחד = לא מתאים ✗
   - חדר וחצי = לא מתאים ✗  
   - 2 חדרים = לא מתאים ✗
   - 2.5 חדרים = לא מתאים ✗
...
3. האם המחיר עד 5900 שקל?
   - עד 5900 = מתאים ✓
   - מעל 5900 = לא מתאים ✗

אם אפילו תנאי אחד לא מתקיים = "no match"
רק אם כל 3 התנאים מתקיימים = "match"
